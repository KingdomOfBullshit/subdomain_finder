...
cat $url/recon/assets.txt | sort -u >> $url/recon/sub_domains.txt
...
cat $url/recon/https_subdomains.txt $url/recon/http_subdomains.txt | sort -u >> $url/recon/both_http_and_https_subdomains.txt
